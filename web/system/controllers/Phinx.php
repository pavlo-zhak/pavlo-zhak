...
class Phinx extends CI_Controller
{
    ...
    public function help()
    {
        ...
        echo (new ConsoleColors())->getColoredString('php igniter phinx migrate - migrate all migrations', 'green', 'black') . PHP_EOL;
        echo (new ConsoleColors())->getColoredString('php igniter phinx rollback - rollback last migration', 'green', 'black') . PHP_EOL;
        echo PHP_EOL;
        echo (new ConsoleColors())->getColoredString('For more information please visit https://github.com/TheFrozenThrone/Codeigniter3/wiki', 'cyan', 'black') . PHP_EOL;
