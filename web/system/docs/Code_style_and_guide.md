...
Для созданий миграций используем Phinx. Также есть алиасы в Igniter [Igniter - cli guide](https://github.com/TheFrozenThrone/Codeigniter3/blob/master/docs/Igniter.md)
