...
class Settings {
    ...
    {
        $q = App::get_ci()->s->from(static::TABLE)->select(static::SETTINGS_SELECT)->many();
    ...
    {
        return App::get_ci()->s->from(static::TABLE)->sortAsc('`key`')->select(static::SETTINGS_SELECT)->many();
    }
    ...
    public static function change(string $key, string $value): bool
    {
        ...
        return App::get_ci()->s->is_affected();
    }
